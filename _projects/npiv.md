---
layout: page
title: NPIV Regression through Stochastic Approximate Gradients
description: Joint work with Yuri Saporito (FGV EMAp) and Yuri Fonseca (UCL)
img: assets/img/npiv.png
importance: 1
category: EMAp
...
<a href="https://openreview.net/forum?id=VqxODXhU4k">Link to the Open Review page.</a>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/npiv.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>